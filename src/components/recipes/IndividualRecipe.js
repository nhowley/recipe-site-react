  ...
  if (recipe){
    return(
      ...
      <div className="flex mb-4 flex-wrap sm:flex-no-wrap recipe-content">
        ...
        <hr className="bg-gray-200 h-px mt-2 mb-2 sm:hidden" />
        {recipe.checkboxes["Dairy-Free"] === true ?  
        <div className="bg-purple w-full px-2 py-1 mb-4 text-center text-white text-sm mt-4 dietary sm:hidden"> 
          <p>Dairy Free</p>
        </div>: null}
        {recipe.checkboxes["Gluten-Free"] === true ? 
          ...
          <div className="recipe-image-icons">
            <img className="mx-auto mb-2" src="/img/seafood-risotto.jpg" alt="Seafood Risotto" />
            <div className="mb-2 mt-1 px-2 flex justify-between">
              ...
              <div className="justify-end">
                ...
                <img className="mb-2 sm:inline-block hidden" src="/img/printer.png" width="25px" alt="Printer" />
              </div>
            </div>
            </div>
          ...
          <div className="w-full sm:w-3/4 h-12 p-6 lg:ml-16">
            <div className="title sm:block hidden">
              <h1 className="mb-2 mr-2 text-2xl inline-block">{recipe.title}</h1>
              <img className="mb-2 inline-block" src="/img/edit.png" width="20px" alt="Edit" />
            </div>
              {recipe.checkboxes["Dairy-Free"] === true ?  
              <div className="bg-purple w-32 px-2 py-1 text-center text-white text-sm mt-4 dietary sm:block hidden">
                <p>Dairy Free</p>
              </div> : null}
              {recipe.checkboxes["Gluten-Free"] === true ? 
              <div className="bg-purple w-32 px-2 py-1 text-center text-white text-sm mt-4 dietary sm:block hidden">
              ...
              <div className="cooking-time">
                ...
                <p className="mt-2 ml-3 inline-block font-bold">Cooking Time<span className="text-blue"> {recipe.cookingTimeHours}hr {recipe.cookingTimeMinutes}mins</span></p>
                <hr className="bg-gray-200 h-px mt-4 mb-2" />
              </div>
              <div className="nutrition">
                <p className="mt-2 inline-block font-bold">Nutritional Value</p>
